...
- `method`: The eigensolver method to use ("JD_BLOCK").
...
"""
function randESCSolver(A, X0::AbstractArray, n::Integer, k::Integer; preconditioner=nothing, precond_preparator=nothing, maxiter=100, tol=1e-6, useRandomization=false, method="", orth_method=nothing, verbose=false)
    ...
    if method == "JD_BLOCK"
        ...
        error("Unknown method: $method. Supported methods are: JD_BLOCK.")
    end
end